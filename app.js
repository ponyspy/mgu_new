...
var admin_requests = require('./routes/admin/requests.js');
...
// ------------------------
// *** Admin Requests Block ***
// ------------------------


// === Admin Requests Route
app.route('/auth/requests')
	 .get(checkAuth, admin_requests.list);

// === Admin Request Route
app.route('/auth/requests/:id')
	 .get(checkAuth, admin_requests.request);
